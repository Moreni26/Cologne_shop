...
const Sidebar = () => {
    ...
    return (
      ...
      >
        ...
        <div className="bg-white flex flex-col gap-y-3 py-4 mt-4">
          <div className="flex w-full justify-between items-center">
            ...
            <div
              onClick={clearCart}
              className="cursor-pointer px-4 py-4 bg-red-500 text-white w-12 h-12 justify-center items-center text-xl"
            >
              <FiTrash2 />
            </div>
          </div>
